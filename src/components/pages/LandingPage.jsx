...
export default function LandingPage() {
    ...
    const qrUrl = `https://qr.sepay.vn/img?acc=96247TESTMOAW123&bank=BIDV&amount=179000&des=${orderCode}`;
                            ...
                            {step === 1 ? (
                                ...
                                <div className="space-y-6 flex flex-col items-center">
                                    ...
                                    <div className="w-full space-y-2 text-center text-sm font-medium text-gray-600 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                        ...
                                        <p>Số tiền: <strong className="text-black text-lg">179.000 VNĐ</strong></p>
                                    </div>
